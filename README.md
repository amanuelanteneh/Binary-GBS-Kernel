...
Repo for the code used to generate the data in the paper I co-authored *Efficient graph classification using binary Gaussian boson sampling* forthcoming in the 
