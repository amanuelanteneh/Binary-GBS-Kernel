...
from grakel import GraphKernel, Graph, RandomWalk
from grakel import graph_from_networkx
...
# random walk kernel
rw = {"name": 'random_walk', "with_labels": False, "lamda": l, "method_type": 'fast', "kernel_type": 'geometric'}
#rw = RandomWalk(lamda=l, normalize=True)
...
for i in range(10): # 10 repeats of double cross validation
  ...
  classifier = make_pipeline(
       GraphKernel(kernel=rw, normalize=True),
